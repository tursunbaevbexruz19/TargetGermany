 ...
 * Groups content types logically so the admin can manage content quickly.
 */
        ...
        .child(
          S.list()
            ...
            .items([
              ...
              S.listItem()
                .title("Program Categories (Navbar)")
                .schemaType("programCategory")
                .child(
                  S.documentTypeList("programCategory")
